...
function HomeViewModel() {
    ...
    self.generateMlTree = function(mlJsonPath) {
        var visRoot;
        console.log("generateMlTree 1: " + mlJsonPath);
        d3.json(mlJsonPath, function(json) {   /*  "js/vendor/d3/flare.json" */
            ...
            console.log("generateMlTree 2: " + mlJsonPath);
            //self.updateXY(tree, visRoot);
            update(visRoot);
        });
        ...
        function update(source) {
            ...
            console.log("generateMlTree 3: " + source);
    ...
    self.updateXY = function (tree, visRoot, source) {

        console.log("generateMlTree 3: " + source);
        var duration = d3.event && d3.event.altKey ? 5000 : 500;

        // Compute the new tree layout.
        //var nodes = tree.nodes(self.d3root).reverse();
        var nodes = tree.nodes(visRoot).reverse();
